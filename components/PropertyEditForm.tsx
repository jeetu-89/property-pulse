    ...
    <form>
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
          <div className="flex items-center">
            ...
            <input
              ...
              name="rates.weekly"
              className="border rounded w-full py-2 px-3"
              defaultValue={property.rates?.weekly ?? undefined}
            />
          </div>
          <div className="flex items-center">
            ...
            <input
              ...
              name="rates.monthly"
              className="border rounded w-full py-2 px-3"
              defaultValue={property.rates?.monthly ?? undefined}
            />
          </div>
          <div className="flex items-center">
            ...
            <input
              ...
              name="rates.nightly"
              className="border rounded w-full py-2 px-3"
              defaultValue={property.rates?.nightly ?? undefined}
            />
          </div>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="border rounded w-full py-2 px-3"
          placeholder="Name"
          defaultValue={property.seller_info?.name ?? undefined}
        />
      </div>
      <div className="mb-4">
        <label
        ...
        <input
          ...
          defaultValue={property.seller_info?.email ?? undefined}
          required
        />
      </div>
      <div className="mb-4">
        ...
        <input
          ...
          className="border rounded w-full py-2 px-3"
          placeholder="Phone"
          defaultValue={property.seller_info?.phone ?? undefined}
        />
      </div>
